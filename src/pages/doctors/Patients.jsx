      ...
      <div className="p-8 flex flex-col gap-8">
        <div className="flex flex-col gap-6">
          {patientsdata.map((item, index) => (
            <section key={index} className="p-4 rounded-md bg-white ">
              <div className="flex flex-col gap-2">
                <div className="flex flex-row items-start justify-between">
                  <div className="flex flex-col gap-1">
                    <div className="flex flex-row items-center gap-2">
                      <span className="text-lg text-[#888888] font-medium ">
                        {item.pid}.
                      </span>
                      <div className="flex flex-row items-center gap-1 text-base font-medium text-[#555555]">
                        <GoPerson /> <span>{item.name}</span> |
                        <span>{item.gender}</span> |
                        <span>{item.age} Years</span>
                      </div>
                    </div>
                    <div className="text-base font-medium text-[#555555]">
                ...
                <div className="flex flex-row justify-between items-center ">
                  ...
                  <div className="flex flex-row items-center gap-4">
                    <button className="text-2xl font-medium text-[#7F03FA]">
                      <BsEye />
                    </button>
                    <button className="text-2xl font-medium text-[#00B252]">
                      <FaEdit />
                    </button>
                  </div>
                </div>
